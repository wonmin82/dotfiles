...
if s:clang_format_is_available
	...
	if v[0] == 7                           " style options for clang-format 7.x
		let g:clang_format#style_options = {
					...
					\   "UseTab" : "Always"
					\}
	elseif v[0] == 6                       " style options for clang-format 6.x
		let g:clang_format#style_options = {
					\   "Language" : "Cpp",
					\   "BasedOnStyle" : "google",
					\   "AccessModifierOffset" : -4,
					...
					\   "UseTab" : "Always"
					\}
	elseif v[0] == 5                       " style options for clang-format 5.x
		let g:clang_format#style_options = {
					\   "Language" : "Cpp",
					\   "BasedOnStyle" : "google",
					\   "AccessModifierOffset" : -4,
					...
					\   "UseTab" : "Always"
					\}
	elseif v[0] == 4                       " style options for clang-format 4.x
		let g:clang_format#style_options = {
					\   "Language" : "Cpp",
					\   "BasedOnStyle" : "google",
					\   "AccessModifierOffset" : -4,
					...
					\   "UseTab" : "Always"
					\}
	elseif v[0] == 3 && v[1] == 9           " style options for clang-format 3.9
		let g:clang_format#style_options = {
					\   "Language" : "Cpp",
					\   "BasedOnStyle" : "google",
					\   "AccessModifierOffset" : -4,
					...
					\   "UseTab" : "Always"
					\}
	elseif v[0] == 3 && v[1] == 8           " style options for clang-format 3.8
		let g:clang_format#style_options = {
					\   "Language" : "Cpp",
					\   "BasedOnStyle" : "google",
					\   "AccessModifierOffset" : -4,
					...
					\   "UseTab" : "Always"
					\}
	elseif v[0] == 3 && v[1] == 7           " style options for clang-format 3.7
		let g:clang_format#style_options = {
					\   "Language" : "Cpp",
					\   "BasedOnStyle" : "google",
					\   "AccessModifierOffset" : -4,
					...
					\   "UseTab" : "Always"
					\}
	elseif v[0] == 3 && v[1] == 6       " style options for clang-format 3.6
		let g:clang_format#style_options = {
					\   "Language" : "Cpp",
					\   "BasedOnStyle" : "google",
					\   "AccessModifierOffset" : -4,
